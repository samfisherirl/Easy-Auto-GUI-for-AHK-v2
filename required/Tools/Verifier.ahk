...
Check:
    ...
    If (Compiler == "Visual Studio") {
        Bat .= """" . CompilerPath . """ sizeof.c"
    } Else {
        Bat .= """" . CompilerPath . """ sizeof.c -o sizeof.exe"
    }
