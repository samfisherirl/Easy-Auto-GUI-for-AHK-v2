; Win32 Error Codes Lookup/Listing Tool
...
FormatMessage := DllCall("GetProcAddress", "Ptr", hMod, "AStr", "FormatMessage" . (A_IsUnicode ? "W" : "A"), "Ptr")
...
GetErrorMessage(ErrorCode, LanguageId := 0) {
    Local ErrorMsg
    VarSetCapacity(ErrorMsg, 8192, 0)
